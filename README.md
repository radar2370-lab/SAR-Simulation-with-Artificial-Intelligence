...
How to use
Enter a location or click on the map to set the Last Known Point
Select subject type, age, terrain, and hours missing
Probability rings update automatically
Optionally, click "Generate AI Search Polygons" for AI-powered priority zones
Export to CalTopo via KML or GPX
Live demo
Visit the live tool (replace with your actual URL).
Architecture
